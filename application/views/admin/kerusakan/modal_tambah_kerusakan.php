    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Kerusakan" required>
        </div>

        <div class="form-group">
          <label for="probabilitas">Nilai Probabilitas</label>
          <input type="number" class="form-control" id="probabilitas" name="probabilitas" placeholder="Nilai Probabilitas" step="0.01" max="1" required>
        </div>

        <div class="form-group">
          <label for="gambar">Masukkan Gambar Hardware</label>
          <input type="file" class="form-control" id="gambar" name="gambar" placeholder="Gambar Hardware" required>
        </div>

        <div class="form-group">
          <label for="solusi">Solusi</label>
          <textarea id="solusi" class="form-control" name="solusi" placeholder="Masukkan Solusi..." required></textarea>
        </div>
      </div>
