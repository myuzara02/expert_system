      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama" name="nama" value="<?= $rusak['nama_kerusakan']; ?>" required>
          </div>
          <div class="form-group">
            <label for="probabilitas">Nilai Probabilitas</label>
            <input type="number" class="form-control" id="probabilitas" name="probabilitas" value="<?= $rusak['probabilitas']; ?>" step="0.01" max="1" required >
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea id="solusi" class="form-control" name="solusi" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="255" data-parsley-validation-threshold="10" required><?= $rusak['solusi']; ?></textarea>
          </div>
        </div>
